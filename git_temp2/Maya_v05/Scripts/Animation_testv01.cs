...
public class Animation_testv01 : MonoBehaviour   
{
    ...
    [SerializeField] public AudioClip[] aizuchiClips;

    [SerializeField] public AudioClip[] actionClips;

    [SerializeField] public AudioClip[] wordClips;
    ...
    void WordPlayBack(int wordIndex)
    {
        audioSource.PlayOneShot(wordClips[wordIndex-1], 1.0f);
    }
